...
function useRainbowWallet() {
    ...
    const provider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useRainbowWallet.useMemo[provider]": ()=>{
            if (!walletClient) return undefined;
            // Create an Eip1193Provider adapter from wagmi's wallet client
            return {
                request: ({
                    "useRainbowWallet.useMemo[provider]": async (args)=>{
    ...
    const ethersSigner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useRainbowWallet.useMemo[ethersSigner]": ()=>{
            if (!provider || !address || !isConnected) return undefined;
            const browserProvider = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(provider);
            return new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].JsonRpcSigner(browserProvider, address);
        }
    }["useRainbowWallet.useMemo[ethersSigner]"], [
        provider,
        address,
    ...
    const ethersReadonlyProvider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useRainbowWallet.useMemo[ethersReadonlyProvider]": ()=>{
            if (!provider) return undefined;
            return new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(provider);
        }
    }["useRainbowWallet.useMemo[ethersReadonlyProvider]"], [
        provider
    ]);
...
_s(useRainbowWallet, "uEnIoP9y2FNxsSYw7L4OIoR664g=", false, function() {
    return [
...
"[project]/frontend/abi/ProductionDeltaAddresses.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/abi/ProductionDeltaABI.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/hooks/useProductionDelta.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$ProductionDeltaAddresses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/abi/ProductionDeltaAddresses.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$ProductionDeltaABI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/abi/ProductionDeltaABI.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
;
...
function getProductionDeltaByChainId(chainId) {
    if (!chainId) {
        return {
            abi: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$ProductionDeltaABI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductionDeltaABI"].abi
        };
    }
    const entry = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$ProductionDeltaAddresses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductionDeltaAddresses"][chainId.toString()];
...
const useProductionDelta = (parameters)=>{
    ...
    const [deltaHandle, setDeltaHandle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const [clearDelta, setClearDelta] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const clearDeltaRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    ...
    const [isCalculating, setIsCalculating] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const productionDeltaRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    ...
    const isCalculatingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(isCalculating);
    const isDecrypted = deltaHandle && deltaHandle === (clearDelta === null || clearDelta === void 0 ? void 0 : clearDelta.handle);
    const productionDelta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductionDelta.useMemo[productionDelta]": ()=>{
            const c = getProductionDeltaByChainId(chainId);
            productionDeltaRef.current = c;
            if (!c.address) {
                setMessage("ProductionDelta deployment not found for chainId=".concat(chainId, "."));
            }
            return c;
        }
    }["useProductionDelta.useMemo[productionDelta]"], [
    ...
    const isDeployed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductionDelta.useMemo[isDeployed]": ()=>{
            if (!productionDelta) {
                return undefined;
            }
            return Boolean(productionDelta.address) && productionDelta.address !== __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroAddress;
        }
    }["useProductionDelta.useMemo[isDeployed]"], [
        productionDelta
    ]);
    const canGetDelta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductionDelta.useMemo[canGetDelta]": ()=>{
    ...
    const refreshDeltaHandle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProductionDelta.useCallback[refreshDeltaHandle]": ()=>{
            var _productionDeltaRef_current, _productionDeltaRef_current1;
            if (isRefreshingRef.current) {
                return;
            }
            if (!productionDeltaRef.current || !((_productionDeltaRef_current = productionDeltaRef.current) === null || _productionDeltaRef_current === void 0 ? void 0 : _productionDeltaRef_current.chainId) || !((_productionDeltaRef_current1 = productionDeltaRef.current) === null || _productionDeltaRef_current1 === void 0 ? void 0 : _productionDeltaRef_current1.address) || !ethersReadonlyProvider) {
            ...
            const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(thisAddress, productionDeltaRef.current.abi, ethersReadonlyProvider);
            contract.getDelta().then({
                "useProductionDelta.useCallback[refreshDeltaHandle]": (value)=>{
                    var _productionDeltaRef_current;
                    if (sameChain.current(thisChainId) && thisAddress === ((_productionDeltaRef_current = productionDeltaRef.current) === null || _productionDeltaRef_current === void 0 ? void 0 : _productionDeltaRef_current.address)) {
                        setDeltaHandle(value);
                    }
                    isRefreshingRef.current = false;
                    setIsRefreshing(false);
                }
            }["useProductionDelta.useCallback[refreshDeltaHandle]"]).catch({
                "useProductionDelta.useCallback[refreshDeltaHandle]": (e)=>{
    ...
    const canDecrypt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductionDelta.useMemo[canDecrypt]": ()=>{
            return productionDelta.address && instance && ethersSigner && !isRefreshing && !isDecrypting && deltaHandle && deltaHandle !== __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroHash && deltaHandle !== (clearDelta === null || clearDelta === void 0 ? void 0 : clearDelta.handle);
        }
    }["useProductionDelta.useMemo[canDecrypt]"], [
        productionDelta.address,
        instance,
    ...
    const decryptDeltaHandle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProductionDelta.useCallback[decryptDeltaHandle]": ()=>{
            var _clearDeltaRef_current;
            ...
            if (deltaHandle === ((_clearDeltaRef_current = clearDeltaRef.current) === null || _clearDeltaRef_current === void 0 ? void 0 : _clearDeltaRef_current.handle)) {
                return;
            }
            if (!deltaHandle) {
            ...
            if (deltaHandle === __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroHash) {
                setClearDelta({
                    handle: deltaHandle,
                    clear: BigInt(0)
                });
            ...
            const run = {
                "useProductionDelta.useCallback[decryptDeltaHandle].run": async ()=>{
                    const isStale = {
                        "useProductionDelta.useCallback[decryptDeltaHandle].run.isStale": ()=>{
                            var _productionDeltaRef_current;
                            return thisAddress !== ((_productionDeltaRef_current = productionDeltaRef.current) === null || _productionDeltaRef_current === void 0 ? void 0 : _productionDeltaRef_current.address) || !sameChain.current(thisChainId) || !sameSigner.current(thisEthersSigner);
                        }
                    }["useProductionDelta.useCallback[decryptDeltaHandle].run.isStale"];
                    try {
            ...
            }["useProductionDelta.useCallback[decryptDeltaHandle].run"];
            run();
        }
    }["useProductionDelta.useCallback[decryptDeltaHandle]"], [
    ...
    const canSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductionDelta.useMemo[canSubmit]": ()=>{
    ...
    const submitProduction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProductionDelta.useCallback[submitProduction]": (value, isToday)=>{
            ...
            const thisAddress = productionDelta.address;
            const thisEthersSigner = ethersSigner;
            const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(thisAddress, productionDelta.abi, thisEthersSigner);
            const op = isToday ? "setTodayProduction" : "setYesterdayProduction";
            const opMsg = "".concat(op, "(").concat(value, ")");
            isSubmittingRef.current = true;
            setIsSubmitting(true);
            setMessage("Start ".concat(opMsg, "..."));
            const run = {
                "useProductionDelta.useCallback[submitProduction].run": async ()=>{
                    await new Promise({
                        "useProductionDelta.useCallback[submitProduction].run": (resolve)=>setTimeout(resolve, 100)
                    }["useProductionDelta.useCallback[submitProduction].run"]);
                    const isStale = {
                        "useProductionDelta.useCallback[submitProduction].run.isStale": ()=>{
                            var _productionDeltaRef_current;
                            return thisAddress !== ((_productionDeltaRef_current = productionDeltaRef.current) === null || _productionDeltaRef_current === void 0 ? void 0 : _productionDeltaRef_current.address) || !sameChain.current(thisChainId) || !sameSigner.current(thisEthersSigner);
                        }
                    }["useProductionDelta.useCallback[submitProduction].run.isStale"];
                    try {
                        ...
                        if (isStale()) {
                            setMessage("Ignore ".concat(opMsg));
                            return;
                        }
                        setMessage("Call ".concat(opMsg, "..."));
                        const tx = await contract[op](enc.handles[0], enc.inputProof);
                        setMessage("Wait for tx:".concat(tx.hash, "..."));
                        const receipt = await tx.wait();
                        setMessage("Call ".concat(opMsg, " completed status=").concat(receipt === null || receipt === void 0 ? void 0 : receipt.status));
                        if (isStale()) {
                            setMessage("Ignore ".concat(opMsg));
                            return;
                        }
                        ...
                        if (errorMsg.includes('relayer') || errorMsg.includes('ERR_CONNECTION_CLOSED') || errorMsg.includes('Failed to fetch')) {
                            setMessage("".concat(opMsg, " Failed! Relayer service unavailable. Please try using local Hardhat node (chainId: 31337) for testing."));
                        } else {
                            setMessage("".concat(opMsg, " Failed! ").concat(errorMsg));
                        }
                    } finally{
    ...
    }["useProductionDelta.useCallback[submitProduction]"], [
        ethersSigner,
        productionDelta.address,
        productionDelta.abi,
        instance,
    ...
    const canCalculate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductionDelta.useMemo[canCalculate]": ()=>{
    ...
    const calculateDelta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProductionDelta.useCallback[calculateDelta]": ()=>{
            ...
            const run = {
                "useProductionDelta.useCallback[calculateDelta].run": async ()=>{
                    const isStale = {
                        "useProductionDelta.useCallback[calculateDelta].run.isStale": ()=>{
                            var _productionDeltaRef_current;
                            return thisAddress !== ((_productionDeltaRef_current = productionDeltaRef.current) === null || _productionDeltaRef_current === void 0 ? void 0 : _productionDeltaRef_current.address) || !sameChain.current(thisChainId) || !sameSigner.current(thisEthersSigner);
                        }
                    }["useProductionDelta.useCallback[calculateDelta].run.isStale"];
                    try {
                        ...
                        setMessage("Wait for tx:".concat(tx.hash, "..."));
                        const receipt = await tx.wait();
                        setMessage("calculateDelta() completed status=".concat(receipt === null || receipt === void 0 ? void 0 : receipt.status));
                        if (isStale()) {
                        ...
                        setMessage("calculateDelta() Failed! ".concat(e));
                    } finally{
                        isCalculatingRef.current = false;
                        setIsCalculating(false);
                    }
                }
            }["useProductionDelta.useCallback[calculateDelta].run"];
            run();
        }
    }["useProductionDelta.useCallback[calculateDelta]"], [
        ethersSigner,
    ...
    return {
        ...
        isDecrypted,
        message,
        clear: clearDelta === null || clearDelta === void 0 ? void 0 : clearDelta.clear,
        handle: deltaHandle,
        isDecrypting,
        isRefreshing,
        isSubmitting,
...
_s(useProductionDelta, "CI6YbdW1CDqBxpAojjuHDlsCs0s=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/frontend/components/ProductionDeltaDemo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useProductionDelta$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/hooks/useProductionDelta.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const ProductionDeltaDemo = ()=>{
    var _fhevmError_message, _productionDelta_clear;
    _s();
    ...
    const { provider, chainId, isConnected, ethersSigner, ethersReadonlyProvider } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useRainbowWallet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRainbowWallet"])();
    ...
    const ethersSignerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(ethersSigner);
    const sameChain = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        "ProductionDeltaDemo.useRef[sameChain]": (cid)=>{
            return cid === chainIdRef.current;
        }
    }["ProductionDeltaDemo.useRef[sameChain]"]);
    const sameSigner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        "ProductionDeltaDemo.useRef[sameSigner]": (signer)=>{
            return signer === ethersSignerRef.current;
        }
    }["ProductionDeltaDemo.useRef[sameSigner]"]);
    ...
    const productionDelta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useProductionDelta$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductionDelta"])({
    ...
    const [yesterdayValue, setYesterdayValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [todayValue, setTodayValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [showAdvancedStats, setShowAdvancedStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [useBatchMode, setUseBatchMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    if (!mounted) {
        return null;
    }
    ...
    const inputClass = "w-full px-4 py-2 border-2 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-black";
    ...
    if (productionDelta.isDeployed === false) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mx-auto text-center bg-white p-6 rounded-lg border-2 border-black",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    if (fhevmStatus === "error" && fhevmError && !((_fhevmError_message = fhevmError.message) === null || _fhevmError_message === void 0 ? void 0 : _fhevmError_message.includes('Failed to fetch'))) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mx-auto text-center bg-white p-6 rounded-lg border-2 border-black",
            children: [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "col-span-full mx-20 bg-black text-white",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "font-semibold text-3xl m-5",
                    children: [
                        "Production Delta Tracker -",
                        " ",
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "font-mono font-normal text-gray-400",
                            children: "ProductionDelta.sol"
                        }, void 0, false, {
                            fileName: "[project]/frontend/components/ProductionDeltaDemo.tsx",
                            lineNumber: 144,
                            columnNumber: 11
            ...
            chainId === 11155111 && fhevmStatus === "ready" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "col-span-full mx-20 px-4 py-3 rounded-lg bg-white border-2 border-black",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "col-span-full mx-20 mt-4 px-5 pb-4 rounded-lg bg-white border-2 border-black",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    className: "px-3 py-1 rounded text-sm transition-colors border-2 border-black ".concat(useBatchMode ? "bg-black text-white" : "bg-white text-black hover:bg-gray-100"),
                                    onClick: ()=>setUseBatchMode(!useBatchMode),
                                    children: useBatchMode ? "ON" : "OFF"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/components/ProductionDeltaDemo.tsx",
                                    lineNumber: 165,
                                    columnNumber: 13
                    ...
                    useBatchMode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "".concat(buttonClass, " w-full"),
                                disabled: !productionDelta.canSubmit || !yesterdayValue || !todayValue || parseInt(yesterdayValue) <= 0 || parseInt(todayValue) <= 0 || parseInt(yesterdayValue) > 1000000 || parseInt(todayValue) > 1000000,
                                onClick: ()=>{
                                ...
                                children: productionDelta.isSubmitting ? "Submitting Both..." : "Submit Both Values"
                            }, void 0, false, {
                                fileName: "[project]/frontend/components/ProductionDeltaDemo.tsx",
                                lineNumber: 210,
                                columnNumber: 13
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "".concat(buttonClass, " mt-2 w-full"),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "col-span-full mx-20 px-5 pb-4 rounded-lg bg-white border-2 border-black",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: titleClass,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: productionDelta.canDecrypt ? "Decrypt Delta" : productionDelta.isDecrypted ? "Decrypted: ".concat((_productionDelta_clear = productionDelta.clear) === null || _productionDelta_clear === void 0 ? void 0 : _productionDelta_clear.toString()) : productionDelta.isDecrypting ? "Decrypting..." : "Nothing to decrypt"
                            }, void 0, false, {
                                fileName: "[project]/frontend/components/ProductionDeltaDemo.tsx",
                                lineNumber: 297,
                                columnNumber: 11
                    ...
                    productionDelta.isDecrypted && productionDelta.clear !== undefined && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-4 p-4 bg-white rounded-lg border-2 border-black",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: showAdvancedStats ? "Hide Details" : "Show Details"
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/components/ProductionDeltaDemo.tsx",
                                        lineNumber: 318,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: Number(productionDelta.clear) > 0 ? "Today&apos;s production is ".concat(productionDelta.clear.toString(), " units higher than yesterday") : Number(productionDelta.clear) < 0 ? "Today&apos;s production is ".concat((-Number(productionDelta.clear)).toString(), " units lower than yesterday") : "Today&apos;s production matches yesterday&apos;s level"
                            }, void 0, false, {
                                fileName: "[project]/frontend/components/ProductionDeltaDemo.tsx",
                                lineNumber: 325,
                                columnNumber: 13
                            }, ("TURBOPACK compile-time value", void 0)),
                            showAdvancedStats && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-4 p-3 bg-white rounded border-2 border-black",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-black",
                                        children: [
                                            ...
                                            " ",
                                            Number(productionDelta.clear) > 0 ? "📈 Increasing" : Number(productionDelta.clear) < 0 ? "📉 Decreasing" : "➡️ Stable"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/frontend/components/ProductionDeltaDemo.tsx",
                                        lineNumber: 334,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            ...
                                            " ",
                                            Math.abs(Number(productionDelta.clear)),
                                            " units"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/frontend/components/ProductionDeltaDemo.tsx",
...
_s(ProductionDeltaDemo, "UWCL8djL2qHjBswWA50QrlQ2z9g=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useProductionDelta$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductionDelta"]
    ];
});
_c = ProductionDeltaDemo;
var _c;
__turbopack_context__.k.register(_c, "ProductionDeltaDemo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_1c8ef93c._.js.map