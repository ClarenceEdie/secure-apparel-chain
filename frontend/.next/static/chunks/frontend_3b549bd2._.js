...
const config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$rainbow$2d$me$2f$rainbowkit$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getDefaultConfig"])({
    ...
    chains: [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$chains$2f$definitions$2f$mainnet$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainnet"] // Ethereum mainnet
    ],
    ssr: false
});
        ...
        "ErrorSuppressor.useEffect": ()=>{
            ...
            console.error = ({
                "ErrorSuppressor.useEffect": function() {
                    ...
                    if (message.includes('Failed to load resource') && (message.includes('cca-lite.coinbase.com') || message.includes('relayer.testnet.zama.cloud') || message.includes('ERR_BLOCKED_BY_RESPONSE') || message.includes('NotSameOriginAfterDefaultedToSameOriginByCoep'))) {
                        return;
                    }
            ...
            const errorHandler = {
                "ErrorSuppressor.useEffect.errorHandler": (event)=>{
                    ...
                    if (message.includes('Base Account SDK requires the Cross-Origin-Opener-Policy') || message.includes('Analytics SDK') || message.includes('ERR_BLOCKED_BY_RESPONSE') || message.includes('NotSameOriginAfterDefaultedToSameOriginByCoep') || message.includes('cca-lite.coinbase.com')) {
            ...
            const rejectionHandler = {
                "ErrorSuppressor.useEffect.rejectionHandler": (event)=>{
                    ...
                    if (reason.includes('Base Account SDK') || reason.includes('Analytics SDK') || reason.includes('Failed to fetch') || reason.includes('ERR_CONNECTION_CLOSED') || reason.includes('ERR_BLOCKED_BY_RESPONSE') || reason.includes('NotSameOriginAfterDefaultedToSameOriginByCoep') || reason.includes('cca-lite.coinbase.com') || reason.includes('relayer.testnet.zama.cloud')) {
                        event.preventDefault();
                        return false;
                    }
                }
            ...
            const resourceErrorHandler = {
                "ErrorSuppressor.useEffect.resourceErrorHandler": (event)=>{
            ...
            }["ErrorSuppressor.useEffect.resourceErrorHandler"];
